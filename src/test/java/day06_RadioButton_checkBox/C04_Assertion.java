...
public class C04_Assertion {
    ...
    public void test01(){
        ...
        Eğer testleri if ile yaparsak test failed olsa bile kodlar problemsiz çalıştığı için ekranın sol alt tarafında test passed yapar.
         */
        ...
        String actualUrl="https://amazon.com";
        Assert.assertEquals("Url beklenenden farkli",expectedUrl,actualUrl);//istersek başa bir mesaj yazabiliriz/bu mesaj sadece failed olduğunda çıkar
         ...
         */
        /*
         Kod hiçbir assertion ile karşılaşmayıp doğru olarak çalıştığında istediğimiz test failed olsa da
         test passed olur.
          */
