...
public class C02_WebTables extends TestBase {
     ...
     Email basligindaki tum elementleri konsolda yazdiralim(once email basliginin kacinci sirada oldugunu bulalim)
     */
    ...
    public void webTable(){
        ...
        List<WebElement> emailSutunListesi=driver.
                findElements(By.xpath("//tbody//td["+(emailSutunNo+1)+"]"));
